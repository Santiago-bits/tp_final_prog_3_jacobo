...
const s: Record<string, React.CSSProperties> = {
  ...
  container:   { background: 'var(--c-bg-card)', border: '1px solid var(--c-border)', borderRadius: '16px', padding: '24px', display: 'flex', flexDirection: 'column', gap: '16px', maxWidth: '860px', flex: 1, minHeight: 0, overflow: 'hidden' },

  header:      { display: 'flex', alignItems: 'center', justifyContent: 'space-between' },
  headerLeft:  { display: 'flex', alignItems: 'center', gap: '12px' },
  headerIcon:  { fontSize: '28px', background: 'var(--c-bg-deep)', borderRadius: '10px', width: '48px', height: '48px', display: 'flex', alignItems: 'center', justifyContent: 'center' },
  title:       { color: 'var(--c-text-1)', fontSize: '18px', fontWeight: '700', margin: 0 },
  subtitle:    { color: 'var(--c-text-2)', fontSize: '12px', margin: '2px 0 0' },
  btnLimpiar:  { background: 'transparent', border: '1px solid var(--c-border)', borderRadius: '7px', color: 'var(--c-text-3)', fontSize: '12px', padding: '6px 14px', cursor: 'pointer' },

  divider:     { height: '1px', background: 'var(--c-border)' },

  inputRow:    { display: 'flex', gap: '12px', alignItems: 'flex-end' },
  inputGroup:  { display: 'flex', flexDirection: 'column', gap: '5px' },
  label:       { color: 'var(--c-text-2)', fontSize: '10px', fontWeight: '700', letterSpacing: '1px' },
  inputCant:   { width: '72px', background: 'var(--c-bg-deep)', border: '2px solid #eab308', borderRadius: '8px', padding: '10px', color: '#eab308', fontSize: '18px', fontWeight: '700', outline: 'none', textAlign: 'center' },
  inputBusqueda: { width: '100%', background: 'var(--c-bg-deep)', border: '1px solid var(--c-border)', borderRadius: '8px', padding: '11px 14px', color: 'var(--c-text-1)', fontSize: '14px', outline: 'none', boxSizing: 'border-box' as const },

  dropdown:    { position: 'absolute', top: '100%', left: 0, right: 0, background: 'var(--c-bg-card)', border: '1px solid var(--c-border)', borderRadius: '10px', zIndex: 100, marginTop: '4px', overflow: 'hidden', boxShadow: '0 8px 24px rgba(0,0,0,0.5)' },
  dropItem:    { display: 'flex', alignItems: 'center', gap: '10px', padding: '10px 14px', cursor: 'pointer', borderBottom: '1px solid var(--c-border-sub)' },
  dropActive:  { background: 'var(--c-btn)' },
  dropCod:     { fontFamily: 'monospace', fontSize: '11px', color: '#eab308', background: 'var(--c-bg-deep)', border: '1px solid var(--c-border)', padding: '2px 7px', borderRadius: '4px', flexShrink: 0 },
  dropNom:     { flex: 1, color: 'var(--c-text-1)', fontSize: '13px', fontWeight: '600' },
  dropCat:     { color: 'var(--c-text-3)', fontSize: '11px', flexShrink: 0 },
  ...
  th:          { color: 'var(--c-text-2)', fontSize: '10px', fontWeight: '700', letterSpacing: '0.8px', textTransform: 'uppercase' as const },

  itemsArea:   { display: 'flex', flexDirection: 'column', flex: 1, minHeight: 0, overflowY: 'auto' as const },
  vacio:       { color: 'var(--c-text-3)', fontSize: '13px', textAlign: 'center', padding: '24px' },
  itemRow:     { display: 'flex', alignItems: 'center', padding: '10px 4px', borderBottom: '1px solid var(--c-border-sub)', gap: '8px' },
  itemNombre:  { color: 'var(--c-text-1)', fontSize: '14px', fontWeight: '600', margin: 0 },
  itemSub:     { color: 'var(--c-text-2)', fontSize: '11px', margin: '2px 0 0' },
  cell:        { color: 'var(--c-text-2)', fontSize: '14px', display: 'flex', alignItems: 'center' },
  cantItem:    { width: '54px', background: 'var(--c-bg-deep)', border: '1px solid var(--c-border)', borderRadius: '6px', padding: '5px', color: 'var(--c-text-1)', fontSize: '13px', outline: 'none', textAlign: 'center' },
  btnX:        { background: 'transparent', border: 'none', color: 'var(--c-text-3)', cursor: 'pointer', fontSize: '13px', padding: '4px 6px', borderRadius: '4px', width: '32px' },
  ...
  totalLabel:  { color: 'var(--c-text-2)', fontSize: '11px', fontWeight: '700', letterSpacing: '2px' },
  ...
  medioBtn:    { padding: '7px 16px', background: 'var(--c-bg-deep)', border: '1px solid var(--c-border)', borderRadius: '8px', color: 'var(--c-text-3)', fontSize: '13px', fontWeight: '600', cursor: 'pointer' },
  medioBtnOn:  { background: 'rgba(234,179,8,0.1)', border: '1px solid #eab308', color: '#eab308' },

  montoWrap:   { display: 'flex', alignItems: 'center', background: 'var(--c-bg-deep)', border: '1px solid var(--c-border)', borderRadius: '8px', overflow: 'hidden' },
  montoSign:   { color: '#eab308', fontWeight: '700', padding: '0 10px', fontSize: '15px' },
  montoInput:  { background: 'transparent', border: 'none', padding: '10px 10px 10px 0', color: 'var(--c-text-1)', fontSize: '15px', outline: 'none', width: '130px' },
