...
const s: Record<string, React.CSSProperties> = {
  ...
  subtitle:     { color: 'var(--c-text-2)', fontSize: '13px', margin: '3px 0 0' },

  filterBar:    { display: 'flex', gap: '10px', flexWrap: 'wrap' as const, alignItems: 'center' },
  searchInput:  { flex: 1, minWidth: '200px', background: 'var(--c-bg-card)', border: '1px solid var(--c-border)', borderRadius: '8px', padding: '9px 14px', color: 'var(--c-text-1)', fontSize: '14px', outline: 'none' },
  select:       { background: 'var(--c-bg-card)', border: '1px solid var(--c-border)', borderRadius: '8px', padding: '9px 14px', color: 'var(--c-text-2)', fontSize: '13px', outline: 'none', cursor: 'pointer' },
  tabs:         { display: 'flex', gap: '4px', background: 'var(--c-bg-card)', border: '1px solid var(--c-border)', borderRadius: '8px', padding: '3px' },
  tab:          { background: 'transparent', border: 'none', borderRadius: '6px', padding: '5px 12px', color: 'var(--c-text-3)', fontSize: '12px', fontWeight: '500', cursor: 'pointer' },
  tabActive:    { background: 'var(--c-btn)', color: 'var(--c-text-1)', fontWeight: '600' },

  empty:        { color: 'var(--c-text-2)', textAlign: 'center', padding: '60px 20px', background: 'var(--c-bg-card)', borderRadius: '12px', border: '1px solid var(--c-border)', fontSize: '14px' },

  grid:         { display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(270px, 1fr))', gap: '16px' },

  card:         { background: 'var(--c-bg-card)', border: '1px solid var(--c-border)', borderRadius: '14px', padding: '18px', display: 'flex', flexDirection: 'column', gap: '12px', transition: 'border-color 0.2s' },
  cardTop:      { display: 'flex', alignItems: 'center', justifyContent: 'space-between' },
  code:         { fontFamily: 'monospace', background: 'var(--c-bg-deep)', color: '#eab308', border: '1px solid var(--c-border)', borderRadius: '6px', padding: '3px 9px', fontSize: '12px', fontWeight: '700', letterSpacing: '1px' },
  ...
  dotInactive:  { background: 'rgba(100,116,139,0.1)', color: 'var(--c-text-3)', border: '1px solid rgba(100,116,139,0.2)' },

  cardBody:     { display: 'flex', flexDirection: 'column', gap: '6px' },
  productName:  { color: 'var(--c-text-1)', fontSize: '15px', fontWeight: '700', margin: 0, lineHeight: '1.3' },
  catBadge:     { display: 'inline-block', background: 'var(--c-bg-deep)', color: 'var(--c-text-3)', border: '1px solid var(--c-border)', padding: '2px 9px', borderRadius: '20px', fontSize: '11px' },

  descToggle:   { background: 'transparent', border: 'none', color: 'var(--c-text-2)', fontSize: '11px', cursor: 'pointer', textAlign: 'left', padding: 0, fontWeight: '500' },
  descText:     { color: 'var(--c-text-3)', fontSize: '12px', lineHeight: '1.6', background: 'var(--c-bg-deep)', borderRadius: '8px', padding: '10px 12px' },
  ...
  priceLabel:   { color: 'var(--c-text-2)', fontSize: '10px', fontWeight: '600', textTransform: 'uppercase' as const, letterSpacing: '0.5px' },
  priceCost:    { color: 'var(--c-text-3)', fontWeight: '600', fontSize: '14px' },
  priceSale:    { color: '#eab308', fontWeight: '800', fontSize: '17px' },
  priceArrow:   { color: 'var(--c-text-3)', fontSize: '14px', margin: '0 2px', alignSelf: 'flex-end', paddingBottom: '2px' },
  ...
  stockLabel:   { color: 'var(--c-text-2)', fontSize: '11px', fontWeight: '600', textTransform: 'uppercase' as const, letterSpacing: '0.5px' },
  stockNum:     { fontWeight: '800', fontSize: '16px' },
  stockMin:     { color: 'var(--c-text-2)', fontSize: '11px' },
  ...
  stockBarWrap: { height: '4px', background: 'var(--c-bg-deep)', borderRadius: '2px', overflow: 'hidden' },
  stockBar:     { height: '100%', borderRadius: '2px', transition: 'width 0.3s' },

  cardActions:  { display: 'flex', gap: '6px', marginTop: '2px' },
  btnEdit:      { flex: 1, background: 'var(--c-btn)', border: 'none', borderRadius: '7px', padding: '7px 10px', color: 'var(--c-text-2)', fontSize: '12px', fontWeight: '600', cursor: 'pointer' },
  btnToggle:    { flex: 1, background: 'transparent', border: '1px solid var(--c-border)', borderRadius: '7px', padding: '7px 10px', color: 'var(--c-text-3)', fontSize: '12px', fontWeight: '600', cursor: 'pointer' },
  ...
  btnSecondary: { background: 'transparent', color: 'var(--c-text-3)', border: '1px solid var(--c-border)', borderRadius: '8px', padding: '9px 18px', fontWeight: '600', fontSize: '13px', cursor: 'pointer' },
  ...
  modal:        { background: 'var(--c-bg-card)', border: '1px solid var(--c-border)', borderRadius: '16px', padding: '28px', width: '100%', maxWidth: '600px', maxHeight: '90vh', overflowY: 'auto' },
  modalHeader:  { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' },
  modalTitle:   { color: 'var(--c-text-1)', fontSize: '17px', fontWeight: '700', margin: 0 },
  closeBtn:     { background: 'transparent', border: 'none', color: 'var(--c-text-3)', fontSize: '18px', cursor: 'pointer' },
  form:         { display: 'flex', flexDirection: 'column', gap: '16px' },
  section:      { display: 'flex', flexDirection: 'column', gap: '12px', background: 'var(--c-bg-deep)', borderRadius: '10px', padding: '14px' },
  sectionTitle: { color: 'var(--c-text-2)', fontSize: '10px', fontWeight: '700', letterSpacing: '1px', textTransform: 'uppercase' as const, margin: 0 },
  row:          { display: 'flex', gap: '10px' },
  field:        { display: 'flex', flexDirection: 'column', gap: '5px', flex: 1 },
  label:        { color: 'var(--c-text-3)', fontSize: '11px', fontWeight: '600', letterSpacing: '0.5px' },
  input:        { background: 'var(--c-bg-card)', border: '1px solid var(--c-border)', borderRadius: '7px', padding: '9px 12px', color: 'var(--c-text-1)', fontSize: '13px', outline: 'none', width: '100%', boxSizing: 'border-box' as const },
  inputGroup:   { display: 'flex', alignItems: 'center', background: 'var(--c-bg-card)', border: '1px solid var(--c-border)', borderRadius: '7px', overflow: 'hidden' },
  inputPrefix:  { color: '#eab308', fontWeight: '700', padding: '0 8px', fontSize: '13px', flexShrink: 0 },
  inputSuffix:  { color: 'var(--c-text-3)', fontWeight: '600', padding: '0 8px', fontSize: '13px', flexShrink: 0 },
  inputInner:   { flex: 1, background: 'transparent', border: 'none', padding: '9px 8px 9px 0', color: 'var(--c-text-1)', fontSize: '13px', outline: 'none', width: '100%' },
