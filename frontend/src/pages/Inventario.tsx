...
const s: Record<string, React.CSSProperties> = {
  ...
  th: { padding: '10px 16px', textAlign: 'left', color: '#475569', fontSize: '11px', fontWeight: '700', letterSpacing: '0.8px', background: '#0f172a', borderBottom: '1px solid #334155' },
  tr: { borderBottom: '1px solid #334155' },
  td: { padding: '13px 16px', color: '#cbd5e1', fontSize: '14px' },
  emptyRow: { padding: '40px', textAlign: 'center', color: '#475569' },
  productName: { color: '#f1f5f9', fontWeight: '600', fontSize: '14px' },
  productDesc: { color: '#64748b', fontSize: '12px', marginTop: '2px' },
  categoryBadge: { background: '#0f172a', color: '#64748b', border: '1px solid #334155', padding: '2px 9px', borderRadius: '20px', fontSize: '11px' },
  ...
  minStock: { color: '#475569', fontSize: '11px' },
  badge: { padding: '3px 10px', borderRadius: '20px', fontSize: '12px', fontWeight: '600' },
  badgeActive: { background: 'rgba(74,222,128,0.1)', color: '#4ade80', border: '1px solid rgba(74,222,128,0.2)' },
  badgeInactive: { background: 'rgba(100,116,139,0.1)', color: '#64748b', border: '1px solid rgba(100,116,139,0.2)' },
