...
const s: Record<string, React.CSSProperties> = {
  ...
  empty:        { color: 'var(--c-text-2)', textAlign: 'center', padding: '60px', background: 'var(--c-bg-card)', borderRadius: '12px', border: '1px solid var(--c-border)' },
  grid:         { display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '14px' },
  card:         { background: 'var(--c-bg-card)', border: '1px solid var(--c-border)', borderRadius: '12px', padding: '18px', display: 'flex', alignItems: 'center', gap: '14px' },
  cardIcon:     { fontSize: '26px', flexShrink: 0, width: '44px', height: '44px', background: 'var(--c-bg-deep)', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center' },
  cardBody:     { flex: 1, minWidth: 0 },
  cardName:     { color: 'var(--c-text-1)', fontWeight: '600', fontSize: '15px', margin: 0 },
  cardDate:     { color: 'var(--c-text-2)', fontSize: '12px', margin: '4px 0 0' },
  cardActions:  { display: 'flex', gap: '6px', flexShrink: 0 },
  btnIcon:      { background: 'var(--c-btn)', border: 'none', borderRadius: '7px', padding: '7px 10px', cursor: 'pointer', fontSize: '14px' },
  ...
  modal:        { background: 'var(--c-bg-card)', border: '1px solid var(--c-border)', borderRadius: '16px', padding: '28px', width: '100%', maxWidth: '440px' },
  ...
  input:        { background: 'var(--c-bg-deep)', border: '1px solid var(--c-border)', borderRadius: '8px', padding: '10px 14px', color: 'var(--c-text-1)', fontSize: '14px', outline: 'none', width: '100%', boxSizing: 'border-box' as const },
